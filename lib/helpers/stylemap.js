...
export const _dotProp = (string, object) =>
    string.split(".").reduce((acc, key) => acc[key], object);

export const mapToTheme = (key, prop) => props =>
    prop ? styledMap(prop, _dotProp(key, props.theme)) : styledMap(_dotProp(key, props.theme));
